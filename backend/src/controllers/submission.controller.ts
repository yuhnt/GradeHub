...
import { createSubmissionSchema, listMySubmissionsQuerySchema } from '../validators/submission.validator';
...
export const submissionController = {
  ...
  async listMine(req: Request, res: Response) {
    ...
    const result = await submissionService.listMine(currentUserId(req), parsed.data.taskId);
